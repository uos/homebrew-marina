...
# Template file — CI replaces 0.2.5 and be8b3676889ee41c7b912d3e280bfad85532d9fe71d9848413b7a9249494a20a
...
class Marina < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "be8b3676889ee41c7b912d3e280bfad85532d9fe71d9848413b7a9249494a20a"
    end
  end
